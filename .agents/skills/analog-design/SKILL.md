...
6. If a target misses, use `scripts/propose_sizing.py` or a scoped spec override.
7. Re-run the same simulation path and update the report with measured results.
8. Move to Xschem, layout, DRC, LVS, and PEX only after schematic simulation has evidence.
